 ...
 */
export function dxtToRgb565(src, src16Offset, width, height) {
 ...
 * @return {Uint16Array} dst
 */
export function dxtToRgb565Unoptimized(src, srcByteOffset, width, height) {
  var c = new Uint16Array(4);
  var dst = new Uint16Array(width * height);
  var nWords = (width * height) / 4;
