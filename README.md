...
## Basis Image Web component

A webcomponent to render and display a basis image file.
...
```
  <basis-transcoder basis-src="apple.basis" height=1048 width=1000></basis-transcoder>
```
